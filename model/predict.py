...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', '-p', default='./run/electrode/fashion-deeplabv3p-resnet-ft-all/experiment_10/checkpoint.pth.tar',
                        metavar='model_path', help="Specify Model Path")

    parser.add_argument('--input', '-i', default='../data/electrode/predict_img/input/013.jpg', metavar='input_path',
                        help='Input image ', required=False)

    parser.add_argument('--output', '-o', default='../data/electrode/predict_img/output/013.png', metavar='output_path',
    ...
    img = Image.open(args.input).convert('RGB').resize((300, 300), Image.BILINEAR)
