...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=3, k_size=[3, 3, 3, 3]):
        self.inplanes = 64
...
def eca_resnet18(k_size=[3, 3, 3, 3], num_classes=3, pretrained=False):
...
def eca_resnet34(k_size=[3, 3, 3, 3], num_classes=3, pretrained=False):
...
def eca_resnet50(k_size=[3, 3, 3, 3], num_classes=3, pretrained=False):
...
def eca_resnet101(k_size=[3, 3, 3, 3], num_classes=3, pretrained=False):
...
def eca_resnet152(k_size=[3, 3, 3, 3], num_classes=3, pretrained=False):
