...
class RCCAModule(nn.Module):
    def __init__(self, recurrence=2, in_channels=2048, num_categories=3):
        ...
        self.cls_seg = nn.Sequential(
            ...
            nn.Conv2d(self.inter_channels, self.num_categories, 1)
        )
...
class CCNet(nn.Module):
    def __init__(self, num_categories=3):
        ...
        self.decode_head = RCCAModule(recurrence=2, in_channels=2048, num_categories=num_categories)
