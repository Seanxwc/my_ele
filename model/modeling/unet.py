...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        out4 = self.downconv4(out3)  # 75 * 50*256

        out5 = self.upconv1(out4, out3)  # 150*100*384
        out6 = self.upconv2(out5, out2)
        out7 = self.upconv3(out6, out1)
        out8 = self.upconv4(out7, out0)
