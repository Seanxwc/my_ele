...
class UTNet(nn.Module):
    ...
    def __init__(self, in_chan=3, base_chan=32, num_classes=3, reduce_size=8, block_list='1234', num_blocks=[1,1,1,1], projection='interp', num_heads=[4,4,4,4], attn_drop=0.1, proj_drop=0.1, bottleneck=False, maxpool=True, rel_pos=True, aux_loss=False):
        super().__init__()
